    ...
    initModal() {
        ...
        `;
         ...
         switchImage = (event) => {
             ...
             if(buttonNode.classList.contains(explosionNavPrevClassName) && this.currentIndex > 0) { this.currentIndex -= 1;
             }

             if(buttonNode.classList.contains(explosionNavNextClassName) && this.currentIndex < this.size - 1) { this.currentIndex += 1;
         }
         ...
         activateGallery = (event) => {
             ...
             if (
                 !linkNode
                 || this.modalContainerNode.classList.contains
         ...
         setInitPositionToImage() {
            this.linkNodes.forEach((linkNode, index) => {
                const data = linkNode.getBoundingClientRect();
                this.setInitPositionStyles(
         ...
         setInitPositionStyles(element, x, y) {
